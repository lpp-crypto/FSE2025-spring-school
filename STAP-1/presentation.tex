% Time-stamp: <2025-03-07 18:23:03>
...
\begin{frame}{Web Encryption}
  \begin{center}
    \begin{tikzpicture}[xscale=1.5,yscale=1.3]
      ...
      \onslide<4->{
        \draw[color=blue] (0, 0) rectangle (4.5, 2) node[pos=0.85,above] {Modes of operation};
      }
      \onslide<5->{
...
\begin{frame}{Multi-Party Computations}
  ...
  \begin{alertblock}{Example}
    Secret sharing
    %!TODO! mpc example: secret sharing 
  \end{alertblock}
...
\begin{frame}{??}
  ...
  %!TODO! an AO hash function within a ZK-protocol
\end{frame}
    ...
    \begin{column}{0.37\textwidth}
      \onslide<3->{
        \begin{center}
          ...
          source:
          {\small
            \emph{``The Algebraic Freelunch: Efficient {Gr{\"o}bner} Basis Attacks Against Arithmetization-Oriented Primitives''}}
        \end{center}
      }
    \end{column}
  \end{columns}
